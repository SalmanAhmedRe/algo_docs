...
qa_prompt = PromptTemplate(
    ...
    'reply with most relevant context. '
    "If the score in context is less than 5, that means it's less likely that paragraph is relevant."
    "If all paragraphs in context has less than 5 score, and context has insufficient information then reply with I cannot answer."
